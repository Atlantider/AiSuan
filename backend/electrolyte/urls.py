...
urlpatterns = [
    ...
    # 新增INP文件相关路由
    path('formulations/<uuid:formulation_id>/input-file/', save_input_file, name='save-input-file'),
    path('formulations/<uuid:formulation_id>/check-input-file/', check_input_file, name='check-input-file'),
    
    # 新增计算任务相关路由
    path('submit-calculation/', submit_calculation, name='submit-calculation'),
    path('calculations/<uuid:calculation_id>/status/', get_calculation_status, name='calculation-status'),
    path('calculations/<uuid:calculation_id>/results/', get_calculation_results, name='calculation-results'),
